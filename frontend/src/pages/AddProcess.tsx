...
function AddProcess() {
  ...
  const clientesUrl = "http://18.225.117.159:3000/clientes";
  const partesContrariasUrl = "http://18.225.117.159:3000/partes-contrarias";
  const TipoProcessoUrl = "http://18.225.117.159:3000/tipos-de-processo";
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      const response = await axios.post("http://18.225.117.159:3000/processos", {
      ...
      await axios.put(`http://18.225.117.159:3000/processos/${newProcessoId}`, {
        cliente: selectedCliente,
        parteContraria: selectedParteContraria,
        numeroProcesso: semNumeroProcesso ? undefined : numeroProcesso,
        tipoProcesso: selectedTipoProcesso,
  ...
  const handleCadastrarParteContrariaSubmit = (event) => {
    ...
    const url = 'http://18.225.117.159:3000/adicionar-parte-contraria';
    const data = {
